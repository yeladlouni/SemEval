==============================================================
Scorer for SemEval-2017 Task 3: "Community Question Answering"
Version 2.3: November 29, 2017
==============================================================

This file contains the basic information regarding the scorer
for SemEval-2017 Task 3 "Community Question Answering",
which can be used for all subtasks, namely
- subtasks A, B, C (English)
- subtask D (Arabic)
- subtask E (English, cross-domain).


[1] LIST OF VERSIONS

  v2.3 [2016/11/29]: Added files and adjusted the scorer for subtask E which is new this year
...
[2] CONTENTS OF THE DISTRIBUTION 2.3
...
* SemEval2017_task3_English_random_baseline_subtask{A,B,C}.pl
  Perl script that generates output for a random baseline
  + IR scores & gold standard labels that are needed for the scorer
  for subtask {A,B,C}

* SemEval2017-Task3-CQA-QL-dev-subtaskA.xml.subtaskA.relevancy
  IR scores & gold standard labels for subtask A
  generated by the above script for SemEval2017-Task3-CQA-QL-dev-subtaskA.xml

* SemEval2017-Task3-CQA-QL-dev.xml.subtask{B,C}.relevancy
  IR scores & gold standard labels for subtask {B,C}
  generated by the above script for SemEval2017-Task3-CQA-QL-dev.xml

* stackexchange_{android,english,gaming,wordpress}_devel.xml.subtaskE.relevancy.bm25
  BM25 oracle scores & gold standard labels for subtask E

* SemEval2017-Task3-CQA-QL-dev-subtaskA.xml.subtaskA.pred
  Predictions for a random baseline for subtask A
  generated by the above script for SemEval2017-Task3-CQA-QL-dev-subtaskA.xml

* SemEval2017-Task3-CQA-QL-dev.xml.subtask{B,C}.pred
  Predictions for a random baseline for subtask {B,C}
  generated by the above script for SemEval2017-Task3-CQA-QL-dev.xml

* stackexchange_{android,english,gaming,wordpress}_devel.xml.subtaskE.pred
  predictions for a random baseline for subtask E
...
* SemEval2017_task3_Arabic_generate_relevancy_file_subtaskD.pl
  Perl script that generates the IR scores & the gold standard labels
  that are needed for the scorer for subtask D (Arabic)
  
* SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.relevancy
  IR scores & gold standard labels for subtask D (Arabic)
  generated by the above script for SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.gz

* SemEval2017_task3_Arabic_random_baseline_subtaskD.pl
  Perl script that generates output for a random baseline for subtask D

* SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.pred
...
Example use:
   python MAP_scripts/ev.py SemEval2017-Task3-CQA-QL-dev-subtaskA.xml.subtaskA.relevancy SemEval2017-Task3-CQA-QL-dev-subtaskA.xml.subtaskA.pred
   ...
   python MAP_scripts/ev.py SemEval2017-Task3-CQA-QL-dev.xml.subtaskC.relevancy SemEval2017-Task3-CQA-QL-dev.xml.subtaskC.pred
   python MAP_scripts/ev.py stackexchange_android_devel.xml.subtaskE.relevancy.bm25 stackexchange_android_devel.xml.subtaskE.pred


Using the baseline/gold label generation scripts (here for subtask A; similarly for subtasks B and C):
   perl SemEval2017_task3_English_baseline_subtaskA.pl <XML-file> 

Example use:
   perl SemEval2017_task3_English_random_baseline_subtaskA.pl SemEval2017-Task3-CQA-QL-dev-subtaskA.xml
   perl SemEval2017_task3_English_random_baseline_subtaskB.pl SemEval2017-Task3-CQA-QL-dev.xml
   perl SemEval2017_task3_English_random_baseline_subtaskC.pl SemEval2017-Task3-CQA-QL-dev.xml


For subtask D (Arabic), the gold labels can be generated using the following script:

   gunzip -c SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.gz | perl SemEval2017_task3_Arabic_generate_relevancy_file_subtaskD.pl > SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.relevancy

Then, a baseline output can be generated as follows:

   gunzip -c SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.gz | perl SemEval2017_task3_Arabic_random_baseline_subtaskD.pl > SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.pred

Finally, scoring can be done using the scoring script as follows:

   python MAP_scripts/ev.py SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.relevancy SemEval2017-Task3-CQA-MD-dev-subtaskD.xml.pred


[4] BASELINES

Baseline MAPs for the three subtasks on SemEval2017-Task3-CQA-QL-dev-subtaskA.xml AND SemEval2017-Task3-CQA-QL-dev.xml
...
(b) BM25 oracle results
  Subtask E Android: TMAP: 0.9944
  Subtask E English: TMAP:
  Subtask E Gaming: TMAP:
  Subtask E Wordpress: TMAP:

(c) All empty result lists baseline (ZERO)
  Subtask E Android: TMAP: 0.9856
  Subtask E English: TMAP:
  Subtask E Gaming: TMAP:
  Subtask E Wordpress: TMAP:
...
This distribution is directly downloadable from the official SemEval-2017 Task 3 website
